...
<asp:Content ID="cPageTitle" ContentPlaceHolderID="cphPageTitle" runat="server">Comic Deleted | Comic Mashup</asp:Content>
<asp:Content ID="cTitle" ContentPlaceHolderID="cphTitle" runat="server">Comic Deleted</asp:Content>
...
<asp:Content ID="cCanvas" ContentPlaceHolderID="cphCanvas" runat="server">
    ...
    <p>Your comic has been deleted.</p>
</asp:Content>