...
Default values are next to each option:
    ...
    * positionOpts (defaults listed below) - location and orientation of the menu, relative to the button/link used to open it
          o posX: 'left' - left side of the menu aligned with a side of the button, left or right
          o posY: 'bottom' - top of the menu aligned with a either top or bottom of the menu
          o offsetX: 0 - number of pixels to offset the menu left/right
          o offsetY: 0 - number of pixels to offset the menu top/bottom
          o directionH: 'right' - horizontal direction in which the menu will open, to the right or left
          o directionV: 'down' - vertical direction in which the menu will open, up or down
          o detectH: true - do horizontal collision detection
          o detectV: true - do vertical collision detection
          o linkToFront: false - set to "true," this option will create a clone of the button and place it over the menu for an overlapping visual effect
