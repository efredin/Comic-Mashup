...
Application.prototype={options:{appId:null,permissions:"",cookieSupport:true,useXfbml:false,user:null,menuSelected:-1,baseHref:"/",facebookBaseHref:"/",requireConnect:false,themeBase:"",onCanvas:false},init:function(){var self=this;
...
if(this.options.onCanvas===true){FB.Canvas.setSize();
...
FB.ui({method:"feed",name:self.options.comic.Title,description:self.options.comic.Description,picture:self.options.comic.FrameThumbUrl,link:self.options.comic.ReadUrl,actions:[{name:"Read",link:self.options.comic.ReadUrl},{name:"Remix",link:self.options.comic.RemixUrl}]},function(response){document.location=data.ReadUrl;
});
